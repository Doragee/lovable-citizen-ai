...
1. 첫 문장은 항상 다음과 같이 작성해야 합니다:
   "안녕하십니까? ${department || '인사혁신처'}입니다. 신청번호 ${complaintNumber || '접수중'}로 문의하신 내용에 대해 다음과 같이 알려드립니다."

2. 두 번째 문장은 항상 다음과 같이 작성해야 합니다:
   "귀하께서 질의하신 사항은 ${summary || '제출하신 민원'}으로 이해됩니다. 해당 문의에 대해 아래와 같이 답변 드리겠습니다."

3. 세 번째 문장부터는 민원에 대한 구체적인 답변을 작성합니다:
   - 민원 제목: ${title}
   - 민원 내용: ${content}
   - 카테고리: ${category}
   위 정보를 바탕으로 법령, 고시, 공고 등 실제 근거를 들어 명확하게 설명해야 하며, 기간·절차·제한사항이 있을 경우 반드시 포함해야 합니다.

4. 마지막 문장은 항상 다음과 같이 작성해야 합니다:
   "답변 내용 중 궁금한 사항이 있으면 ${department || '인사혁신처'}로 연락해 주시면 친절하게 답변 드리겠습니다. 감사합니다. 끝."
