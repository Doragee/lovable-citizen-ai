...
1. 첫 문장은 항상 다음과 같이 작성해야 합니다:
   "안녕하십니까? 인사혁신처 ${department || '인사혁신처'}입니다. 신청번호 ${complaintNumber || '접수중'}로 문의하신 내용에 대해 다음과 같이 알려드립니다."
...
4. 마지막 문장은 항상 다음과 같이 작성해야 합니다:
   "답변 내용 중 궁금한 사항이 있으면 (${department || '인사혁신처'} 담당자, 044-201-8888)로 연락해 주시면 친절하게 답변 드리겠습니다. 감사합니다. 끝."
